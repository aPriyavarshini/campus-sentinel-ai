  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom variants for Sentinel Campus
        hero: "bg-gradient-to-r from-primary to-blue-400 text-primary-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-200",
        danger: "bg-gradient-to-r from-destructive to-red-500 text-destructive-foreground shadow-md hover:shadow-lg",
        success: "bg-gradient-to-r from-success to-emerald-400 text-success-foreground shadow-md hover:shadow-lg",
